...
function liquidFillGaugeDefaultSettings(){
    return {
        ...
        circleColor: "#115d04", // The color of the outer circle.
        waveHeight: 0.06, // The wave height as a percentage of the radius of the wave circle.
        ...
        waveColor: "#115d04", // The color of the fill wave.
...
function loadLiquidFillGauge(elementId, value, config) {
    ...
    let percentText = config.displayPercent?"l":"";
    ...
    let textRiseScaleY = d3.scale.linear()
        .range([fillCircleMargin+fillCircleRadius*2,(fillCircleMargin+textPixels*2)])
        .domain([0,1]);
